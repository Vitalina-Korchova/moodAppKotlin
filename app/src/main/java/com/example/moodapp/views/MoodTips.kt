...
fun MoodTips(windowSizeClass: WindowSizeClass) {
    AndroidView(factory = { context ->
        val view = LayoutInflater.from(context).inflate(R.layout.activity_mood_tips, null)

        val flipper = view.findViewById<ViewFlipper>(R.id.view_flipper)
        val recyclerView = view.findViewById<RecyclerView>(R.id.tips_recycler)
        ...
        recyclerView.adapter = object : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            override fun getItemCount() = moodTipsMap.size
        }
